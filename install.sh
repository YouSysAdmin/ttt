...
usage() {
  this=$1
  cat <<EOF
$this: download go binaries for yousysadmin/ttt

Usage: $this [-b] bindir [-d] [tag]
  -b sets bindir or installation directory, Defaults to ~/.bin
  -d turns on debug logging
   [tag] is a tag from
   https://github.com/yousysadmin/ttt/releases
...
uname_os_check() {
  ...
  log_crit "uname_os_check '$(uname -s)' got converted to '$os' which is not a GOOS value. Please file bug at https://github.com/YouSysAdmin/ttt"
  return 1
}
uname_arch_check() {
  arch=$(uname_arch)
  ...
  log_crit "uname_arch_check '$(uname -m)' got converted to '$arch' which is not a GOARCH value.  Please file bug report at https://github.com/YouSysAdmin/ttt"
  return 1
}
untar() {
  tarball=$1
